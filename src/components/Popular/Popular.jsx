...
import { getCurrentFilter } from '../../classic-redux/selectors';
import { setStatusForFilter } from '../../classic-redux/actionsCreator';
...
export default function Popular() {
    ...
    const statusFilterStore = useSelector(getCurrentFilter);
